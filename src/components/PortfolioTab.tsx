      ...
      <div className="space-y-8">
        {projects.map((project, i) => (
          <Reveal key={project.title} delay={i * 100}>
            <div className="bg-white/5 backdrop-blur-xl rounded-2xl overflow-hidden border border-white/10 hover:-translate-y-1 hover:shadow-xl hover:shadow-gold/5 hover:border-gold/30 hover:bg-white/[0.08] transition-all duration-300">
